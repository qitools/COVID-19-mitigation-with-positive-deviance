pulmnodule <- function(age = 0, diameter = 0, cancer = 0, smoker = 0, spiculation = 0, location = 0){
  ...
  list(
    message = paste(prob, '% probability of cancer. For management options of an indeterminate nodule, see 2013 ACCP Guidelines at <a href=\"http://pubmedcentral.gov/PMC3749714\">PMC3749714</a>.')
  )
